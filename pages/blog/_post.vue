<template>
  <div id="single">
    <slanted-section
      class="hero is-fullheight has-background-dark has-text-white"
      :style="`background: url(${attributes.image}) center no-repeat; background-size: cover; background-blend-mode: soft-light;`"
    >
      <div class="container is-fluid is-flex">
        <div class="columns is-mobile is-vcentered is-centered is-full">
          <div class="column is-full has-text-centered">
            <h1 class="title has-text-white" :if="attributes.title">
              {{ attributes.title }}
            </h1>
            <p>
    ...
    <section
      id="bottom"
      class="has-background-dark hero is-halfheight has-text-white"
    >
      <div class="container is-fluid is-flex">
        <div class="columns is-vcentered is-desktop is-mobile">
          <div class="column has-text-centered is-full">
            ...
            <p>
              If you enjoyed this post, click the button below to read more from
              my blog!
            </p>
...
export default {
  ...
  head() {
    return {
      title: `${
        this.attributes.title ? this.attributes.title + " | " : ""
      }David Crandall`,
      meta: [
        {
          hid: "og:image",
